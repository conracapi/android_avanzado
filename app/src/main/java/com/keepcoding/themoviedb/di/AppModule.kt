...
class AppModule {
    ...
    @Provides
    fun providesDetailMovieDao(movieDatabase: MovieDatabase): MovieDetailDao {
        return movieDatabase.movieDetailDao()
    }

    @Provides
    fun providesTranslationMovieDao(movieDatabase: MovieDatabase): MovieTranslationDao {
        return movieDatabase.movieTranslationDao()
    }

    @Provides
    fun providesTvShowDao(movieDatabase: MovieDatabase): TvShowsDao {
        return movieDatabase.tvShowDao()
    }

    @Provides
    fun providesDetailTvShowDao(movieDatabase: MovieDatabase): TvShowDetailDao {
        return movieDatabase.tvShowDetailDao()
    }

    @Provides
    fun providesTranslationTvShowDao(movieDatabase: MovieDatabase): TvShowTranslationDao {
        return movieDatabase.tvShowTranslationDao()
    }
