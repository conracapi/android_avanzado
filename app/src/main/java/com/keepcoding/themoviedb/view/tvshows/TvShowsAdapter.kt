...
class TvShowsAdapter(private var data: ArrayList<TvShowPresentation>,
                     private val clickListener: (TvShowPresentation)->(Unit)
): RecyclerView.Adapter<TvShowsAdapter.MovieViewHolder>() {
    ...
    inner class MovieViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        private var movie: TvShowPresentation? = null
